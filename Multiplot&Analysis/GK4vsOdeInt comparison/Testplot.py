...
array = np.loadtxt(filename)
data1.append(array)
filename = f"OdeInt_sfinal_0.5_nsteps_1000_NGround_25.dat"  # Change this to the actual filenames of your data files
array = np.loadtxt(filename)
data1.append(array)
...
# Plot the arrays
plt.plot(s,data[0], label=r'GK4 $s_f = 0.1$')
...
#plt.plot(s,data1[0], label=r'OdeInt $s_f = 0.1$')
...
plt.ylabel(r'Ground State $E_0$',size = 13)
plt.title(r'')
plt.legend()
